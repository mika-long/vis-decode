...
- The purpose of this study is to understand how people visually estimate the average value of data presented in line graphs.
...
- You will be shown line graphs displaying data points, and for each graph you will be asked to estimate the average (mean) value of the data shown.
- For each graph, you will make your judgment by:
    - Looking at the graph
    - Using an interactive slider to position a horizontal reference line at your estimated average value
    - Moving on to the next graph when ready
- You will be given ample training and instructions before the main tasks begin.
- You will have unlimited time for each judgment, with brief breaks provided throughout the study.
- You will complete **48** trials in total, plus **4** practice trials at the beginning.
...
- You will receive a base payment of **$3.50** for completing the study, plus the opportunity to earn additional bonuses of up to **$1.50**.
...
- Better understand how people perceive and estimate statistical information from data visualizations
- Develop more effective ways to design and present statistical graphics
- Improve how quantitative information is communicated to help people make better decisions
