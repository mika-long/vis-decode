...
We expect about 20 – 40 people will be in this research study.
...
- For each trial, you will:
    - Look at the graph
    - Use the interactive interface to indicate your response
    - Move on to the next trial when ready
- You will be given ample training and instructions before each task begins.
- You will have unlimited time for each judgment, with brief breaks provided throughout the study.
- You will complete **4 practice trials** and **58 test trials** in total.
